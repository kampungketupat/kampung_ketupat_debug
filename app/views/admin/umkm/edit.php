        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                ...
                <form action="<?= BASE_URL ?>/admin/umkm/update"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="form-label fw-500">Nama UMKM</label>
                            <input type="text" name="nama_umkm" class="form-control"
                                value="<?= htmlspecialchars($umkm['nama_umkm']) ?>" required />
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="kategori" class="form-select">
                                <?php foreach (['kuliner', 'kerajinan', 'souvenir', 'jasa', 'lainnya'] as $k): ?>
                                    <option value="<?= $k ?>" <?= $umkm['kategori'] === $k ? 'selected' : '' ?>>
                                        <?= ucfirst($k) ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="produk_unggulan" class="form-control"
                            value="<?= htmlspecialchars($umkm['produk_unggulan'] ?? '') ?>" />
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-500">Alamat</label>
                        <input type="text" name="alamat" class="form-control"
                            value="<?= htmlspecialchars($umkm['alamat'] ?? '') ?>" />
                    </div>
